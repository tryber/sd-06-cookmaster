...
const authorizationAdminError = (message) => 
generateError(status.NOT_ADMIN, 'Not_Authorized', message);
...
module.exports = {
  generateError, authorizationError, validationError, notFoundError, authorizationAdminError,
};
